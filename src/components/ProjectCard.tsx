    ...
    <motion.div {...rest} className="w-full max-w-[350px]">
      <button
        onClick={(e) => {
          ...
          window.open(url || repo || img || '_self');
        }}
        className="
          group bg-bg-secondary block w-full shadow-xl dark:shadow-2xl
      ...
      >
        <div className="relative overflow-hidden h-[200px]">
          ...
          <div className="absolute inset-0 flex items-center justify-center p-2 opacity-0 hover:opacity-100 transition-opacity duration-300 bg-bg-secondary-light backdrop-blur-sm">
            <span className="text-dark-1 [text-shadow:_0_1px_0_rgb(0_0_0_/_50%)]">{desc}</span>
          </div>
        </div>
